...
@section('content')
    <section class="p-8 mt-10 bg-gray-100 flex flex-col items-center">
        ...
        @foreach ($data as $title => $service)
            <div class="bg-white p-6 rounded-lg shadow-md mb-8 w-3/4">
                <h3 class="text-3xl font-semibold mb-4 text-gray-800 px-12 py-8">{{ $title }}</h3>
                <p class="text-base text-gray-700 leading-relaxed px-12 py-8">
