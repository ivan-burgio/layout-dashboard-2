        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                <div class="flex justify-between mb-4 items-start">
                    ...
                    <a href="/dashboard/agenda/tickets" class="text-[#f84525] font-medium text-sm hover:text-red-800">View</a>
                </div>
                            ...
                            @foreach ($ticketsPendientes as $ticket)
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <p class="text-gray-600 text-sm font-medium ml-2">
                                                {{ $ticket->titulo }}</p>
                                        </div>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span
                                            class="text-[13px] font-medium text-gray-400">{{ $ticket->created_at->format('d-m-Y') }}</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span
                                            class="text-[13px] font-medium text-gray-400">{{ $ticket->prioridad }}</span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
