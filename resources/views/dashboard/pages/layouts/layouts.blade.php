...
@section('content')
    {{-- @include('dashboard.components.creacion.modal_web') --}}

    <div class="relative overflow-x-auto m-8">
        <div class="flex flex-row w-full justify-between">
            <button id="openModalButtonWeb" class="bg-sky-800 hover:bg-sky-950 text-white px-4 py-2 mb-4 rounded-md">
                Nuevo Layout
            </button>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <button class="bg-sky-800 hover:bg-sky-950 text-white px-2 py-1 rounded-md edit-buttonlayout"
                                ...
                                data-tipo="{{ $layout->tipo }}" data-link="{{ $layout->link }}"
