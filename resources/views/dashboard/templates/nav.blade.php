<nav class="bg-gray-800 text-white p-3 flex items-center justify-between w-full h-1/6 relative">
    <div>
    ...
    <div class="flex items-center space-x-4">
        <div class="opcion-con-desplegable hover:cursor-pointer relative">
            ...
            <ul class="desplegable absolute -right-3 mt-2 p-2 bg-gray-800 rounded-md shadow-lg hidden min-w-[150px] z-10">
                <li>
