        ...
        <div class="lg:flex lg:items-center lg:-mx-6">
            <div class="lg:w-1/2 lg:mx-6">
                <h1 class="text-2xl font-semibold text-gray-800 capitalize dark:text-white lg:text-3xl">
                    Contactanos <br> para mas información
                </h1>

                <div class="mt-6 space-y-8 md:mt-8">
                    <p class="flex items-start -mx-2">
                        <i class="fa-solid fa-phone w-6 h-6 mx-2 text-blue-500 dark:text-blue-400 text-2xl"></i>
                        <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">(+598) 90 000 000</span>
                    </p>
                ...
                <div class="mt-6 w-80 md:mt-8">
                    <h3 class="text-gray-600 dark:text-gray-300 ">Siguenos</h3>
                    ...
                    <div class="flex mt-4 -mx-1.5 ">
                        <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500 hover:cursor-pointer"
                            href="#">
                            <i class="fa-brands fa-twitter w-10 h-10 fill-current text-2xl"></i>
                        </a>

                        <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500 hover:cursor-pointer"
                            href="#">
                            <i class="fa-brands fa-linkedin-in w-10 h-10 fill-current text-2xl"></i>
                        </a>

                        <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500 hover:cursor-pointer"
                            href="#">
                            <i class="fa-brands fa-facebook-f w-10 h-10 fill-current text-2xl"></i>
                        </a>

                        <a class="mx-1.5 dark:hover:text-blue-400 text-gray-400 transition-colors duration-300 transform hover:text-blue-500 hover:cursor-pointer"
                            href="#">
                            <i class="fa-brands fa-instagram w-10 h-10 fill-current text-2xl"></i>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-8 lg:w-1/2 lg:mx-6">
                <div
                    ...
                    <h1 class="text-lg font-medium text-white">¿Que quieres preguntarnos?</h1>
